...
/* themes/myboot/templates/field/field.html.twig */
class __TwigTemplate_ca8beabb29011da50e44161401f47d51f9264a8a5fab944e1236ca9f72095ca1 extends Twig_Template
{
...
";
    ...
    {
        return "themes/myboot/templates/field/field.html.twig";
    }
...
/*       {% for item in items %}*/
/*         <div class='col-md-4'{{ item.attributes.addClass('field--item') }}><h4>{{ item.content }}</h4></div>*/
/*       {% endfor %}*/
/*     </div>*/
/*   {% else %}*/
/*     {% for item in items %}*/
/*       <div{{ attributes.addClass(classes, 'field--item') }}><h4>{{ item.content }}</h4></div>*/
/*     {% endfor %}*/
/*   {% endif %}*/
/* {% else %}*/
